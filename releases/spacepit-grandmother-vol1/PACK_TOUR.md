...
├── audio/
│   ├── multisamples/      ← 225 WAVs across patches × chains
│   └── loops/             ← 35 tempo-tagged loops
├── instruments/
│   ├── sfz/               ← 17 SFZ presets (universal cross-DAW)
│   ├── decent-sampler/    ← 17 Decent Sampler .dspreset files
